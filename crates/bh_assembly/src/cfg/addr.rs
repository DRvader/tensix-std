use crate::{
    ...
    SETC16_value, SETC16d,
};

use super::cfg_defs::{
    ADDR_MOD_PACK_SEC0_YsrcIncr_ADDR32, ADDR_MOD_PACK_SEC1_YsrcIncr_ADDR32,
    ADDR_MOD_PACK_SEC2_YsrcIncr_ADDR32, ADDR_MOD_PACK_SEC3_YsrcIncr_ADDR32,
};
...
#[derive(core::marker::ConstParamTy, Default, PartialEq, Eq)]
...
impl PackedAddr {
    ...
    pub fn set(&self, sel: AddrSel) {
        SETC16d!(Self::ADDRS[sel as usize], self.val() as u32);
    }
}
