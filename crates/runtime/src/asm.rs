...
"ncrisc_stack_select:",
    "li t2, 1",
    "beq a1, t2, trisc0_stack_select",
    "li t2, 2",
    "beq a1, t2, trisc1_stack_select",
    "li t2, 3",
    "beq a1, t2, trisc2_stack_select",
    "la t0, ___ncrisc_stack_bottom",
    "la t1, ___ncrisc_stack_top",
    "j stack_init_start",
"trisc0_stack_select:",
    "la t0, ___trisc0_stack_bottom",
    "la t1, ___trisc0_stack_top",
    "j stack_init_start",
"trisc1_stack_select:",
    "la t0, ___trisc1_stack_bottom",
    "la t1, ___trisc1_stack_top",
    "j stack_init_start",
"trisc2_stack_select:",
    "la t0, ___trisc2_stack_bottom",
    "la t1, ___trisc2_stack_top",
    "j stack_init_start",
"stack_init_start:",
